...
SMTP_PORT = 465
SENDER_EMAIL = "udaheju@gmail.com"  # Replace with your email
RECEIVER_EMAIL = "Jules.gilles.1993@gmail.com"  # Replace with recipient email
APP_PASSWORD = "cumx gjex qmzn cpro"  # Replace with your app password
